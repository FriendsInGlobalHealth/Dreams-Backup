...
class BeneficiariosController extends Controller
{
    ...
    public function behaviors()
    {
        ...
        'class' => AccessRule::className(),
                ...
                'rules' => [
                    [
                        'actions' => ['index','view','create','lists','listas','servicos','localidades','bairros','todos','filtros','relatorio','programatic','relatoriofy19','relatoriofy20q1','relatoriofy20q2','dinamico'],
...
O digitadores so visualizam 5 Beneficiarios por lista**/
     ...
     * @return mixed
     */
    public function actionProgramatic()
    {
        $model = new Beneficiarios();

        return $this->render('reportDinamic', [
            'model' => $model,
	...
	{
		$model = new Beneficiaios();

		return $this->render('reportProgramatic', [
			'model' => $model,
		]);
	}
