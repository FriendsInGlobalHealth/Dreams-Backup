...
[['idade_anos'], 'integer', 'min' => 9, 'message' => 'O valor da {attribute} não pode ser menor que 9'],
          [['district_code','emp_lastname','emp_firstname', 'emp_gender', 'provin_code','ponto_entrada','bairro_id','encarregado_educacao','estudante','deficiencia'], 'required'],
          [['emp_dri_lice_exp_date', 'joined_date', 'criado_em', 'actualizado_em','deficiencia_tipo','estudante_classe','estudante_escola','gravida','filhos','house_sustainer','married_before','pregant_or_breastfeed','employed','tested_hiv',
