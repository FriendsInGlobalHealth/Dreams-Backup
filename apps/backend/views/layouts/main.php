...
<?php if (Yii::$app->user->identity->role==20) { echo 0; } else {echo 0;} ?>
 ...
 <li class="treeview">
                            ...
                            <ul id="report" class="collapse">
                                ...
                                <li><a href="<?php echo Url::toRoute('beneficiarios/programatic'); ?>">
...
<?php } ?>
                               ...
                               <?= Html::a(Yii::t('app', '<i class="fa fa-angle-double-right"></i> INDICADORES DREAMS'), ['/beneficiarios/relatorioQ1','id'=>5]) ?> 
                                ...
                                <li><a href="<?php echo Url::toRoute('/beneficiarios/relatoriofy19'); ?>">
                                  <i class="fa fa-angle-double-right"></i> FY19</a>
                                </li>

                              
                              
 			     <li class="treeview">
                            <a href="#"  data-toggle="collapse" data-target="#FY20">
                                  <i class="fa fa-angle-double-right"></i> FY20</a>
                              <!-- <ul class="treeview"> -->
                              <ul id="FY20" class="collapse">
                                <li><a href="<?php echo Url::toRoute('/beneficiarios/relatoriofy20q1'); ?>">
                                  <i class="fa fa-angle-double-right"></i> Q1</a>
                                </li>
                                <li><a href="<?php echo Url::toRoute('/beneficiarios/relatoriofy20q2'); ?>">
                                  <i class="fa fa-angle-double-right"></i> Q2</a>
                                </li>
                          </ul>
                            </ul>
    </li>
