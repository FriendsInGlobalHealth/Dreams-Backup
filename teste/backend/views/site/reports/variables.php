...
<div class="row">
  ...
  <div class="panel panel-success">
    <div class="panel-heading"> <strong align="center"><i class="icon ion-ios-star"></i> CORE SERVICES</strong></div>
...
<div class="panel panel-default">
  <div class="panel-heading"> <strong align="center"><i class="icon ion-ios-star-half"></i> NON-CORE SERVICES</strong></div>
  <div class="panel-body"  style="max-height: 600px;  overflow-y: scroll;">
    <ul  class="list-group">
          <?php
          //core Services
