...
<a class="label label-primary" href="<?php echo Url::toRoute('servicos-beneficiados/create.dreams?m='.$model->id.'&amp;ts=1.dreams');?>"> 
...
Referir Beneficiário', ['referencias-dreams/create','ben' => $model->id], ['class' => 'label label-danger']) ?>
  ...
  <tr> <th> Data</th> <th>Serviço</th><th>  Sub Serviço</th><th>Ponto de Entrada</th>  <th> #  </th> </tr>
...
<td  class='quota_id'> <?= $query->subServicos['name']; ?> </td> 
