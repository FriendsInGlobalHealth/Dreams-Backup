...
-->
   ...
   0 </small></span>'), ['guia-referencias/create']) ?>
                        </li>   
...
<?php if (Yii::$app->user->identity->role==20) { echo 0; } else {echo 0;} ?>
                       ...
                       <li class="treeview">
                            ...
                            <ul  class="treeview-menu">
                                <li>
                                <a href="#"><i class="fa fa-angle-double-right"></i><span> Províncias </span><span class="badge pull-right"> <?= Provincias::find()->count();?></span></a></li>
                                <li>
                                <a href="<?php echo Url::toRoute('distritos/index'); ?>"><i class="fa fa-plus-circle"  style="color:green;"></i> Distritos <span class="badge pull-right"> <?= Distritos::find()->count();?></span></a>
                                </li>
                               ...
                               <li>
                                ...
                                <span class="badge pull-right"> <?= ComiteLocalidades::find()->count();?> 
                                </span>
                                </a>
                                </li>
 <li>
                                <a href="<?php echo Url::toRoute('bairros/index'); ?>"><i class="fa fa-plus-circle"  style="color:green;"></i> <span>Bairros DREAMS<span class="badge pull-right"> <?= Bairros::find()->count();?></span></span></a>
                                </li>
                                <li>
                                <a href="<?php echo Url::toRoute('us/index'); ?>"><i class="fa fa-plus-circle"  style="color:green;"></i> <span>Unidade Sanitária <span class="badge pull-right"> <?= Us::find()->count();?> </span></span></a>
                                </li>


                                   <li>
                                <a href="<?php echo Url::toRoute('servicos-dream/index'); ?>"><i class="fa fa-plus-circle"  style="color:green;"></i> <span>Serviços DREAMS <span class="badge pull-right"> <?= ServicosDream::find()->count();?></span></span></a>
                                </li>

                                        <li>
                                <a href="<?php echo Url::toRoute('sub-servicos-dreams/index'); ?>"><i class="fa fa-plus-circle"  style="color:green;"></i> <span>Sub-Serviços DREAMS <span class="badge pull-right"> <?= SubServicosDreams::find()->count();?></span></span></a>
                                </li>

                                

                                <li>
                                <a href="<?php echo Url::toRoute('organizacoes/index'); ?>"><i class="fa fa-plus-circle"  style="color:green;"></i> <span>Parceiros DREAMS <span class="badge pull-right"> <?= Organizacoes::find()->count();?></span></span></a>
                                </li>

                                <li>
                                <a href="<?php echo Url::toRoute('tipo-servicos/index'); ?>"><i class="fa fa-plus-circle"  style="color:green;"></i> <span>Tipos de Serviços<span class="badge pull-right"> <?= TipoServicos::find()->count();?></span></span></a>
                                </li>
                                   <li>
                                <a href="<?php echo Url::toRoute('parceiros-tipo/index'); ?>"><i class="fa fa-plus-circle"  style="color:green;"></i> <span>Tipos de Parceirias<span class="badge pull-right"> <?= ParceirosTipo::find()->count();?></span></span></a>
                                </li>
         ...
         <?php    if (!Yii::$app->user->isGuest) { ?>
			...
			echo	 Html::img('@web/img/users/profile.png', ['alt' => 'user', 'class'=>'img-circle' ]);
					...
					<!--	<li>
                         ...
                         <li>
                            <a href="<?php echo Url::toRoute('beneficiarios/index'); ?>">
                                <i class="fa fa-group"></i> <span>Lista de Benefici&aacute;rios <small class="badge pull-right bg-green">
								  <?php
												  $ben=0;
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                               <li>
                                ...
                                <li>
                                <a href="<?php echo Url::toRoute('distritos/index'); ?>"><i class="fa fa-globe"  style="color:green;"></i> <span>Distritos <span class="badge pull-right"> <?= Distritos::find()->count();?></span></span></a>
                                </li>
                             
                               <li>
                                <a href="<?php echo Url::toRoute('comite-localidades/index'); ?>">
                                <i class="fa fa-globe"  style="color:green;"></i> Postos Administrativos 
                                <span class="badge pull-right"> <?= ComiteLocalidades::find()->count();?></span></a> 

                                </li>
                                <li>
                                <a href="<?php echo Url::toRoute('us/index'); ?>"><i class="fa fa-hospital-o"  style="color:green;"></i> <span>Unidades Sanitárias <span class="badge pull-right"> <?= Us::find()->count();?></span></span></a>
                                </li>
                                <li>
                                <a href="<?php echo Url::toRoute('bairros/index'); ?>"><i class="fa fa-globe"  style="color:green;"></i> <span>Bairros DREAMS<span class="badge pull-right"> <?= Bairros::find()->count();?></span></span></a>
                                </li>
								<li>
                                <a href="<?php echo Url::toRoute('escolas-dreams/index'); ?>"><i class="fa fa-globe"  style="color:green;"></i> <span>Escolas DREAMS <span class="badge pull-right"> <?= EscolasDreams::find()->count();?></span></span></a>
                                </li>
								
							     <li>
                                <a href="<?php echo Url::toRoute('servicos-dream/index'); ?>"><i class="fa fa-medkit"  style="color:green;"></i> <span>Serviços DREAMS <span class="badge pull-right"> <?= ServicosDream::find()->count();?></span></span></a>
                                </li>	
                                ...
                                <li>
                                <a href="<?php echo Url::toRoute('organizacoes/index'); ?>"><i class="fa fa-briefcase"  style="color:green;"></i> <span>Parceiros DREAMS <span class="badge pull-right"> <?= Organizacoes::find()->count();?></span></span></a>
                                </li>
            ...
            <aside class="right-side">                
             ...
             <?php  if (!Yii::$app->user->isGuest) {   ?>    
                <section class="content-header">
                    <h1>
                      SISTEMA INTEGRADO DE CADASTRO DE BENEFICIARIOS DREAMS 
                      <br>
...
<font size="-1">
<img src="http://dreams.co.mz/images/parceiros/Dreams_moz_Jhpiego_logo.png" width="10%">
<img src="http://dreams.co.mz/images/parceiros/DREAMS_MOZ_FHI360_LOGO.png" width="10%">
<img src="http://dreams.co.mz/images/parceiros/Dreams_mz_wei-combined_logo.png" width="10%">
<img src="http://dreams.co.mz/images/parceiros/dreams_moz_FGH_Logo.png" width="10%">
<img src="http://dreams.co.mz/images/parceiros/Dreams_moz_NWETI_logo.png" width="10%">
<img src="http://dreams.co.mz/images/parceiros/Dreams_mz_World_Vision_logo.png" width="10%">
<img src="http://dreams.co.mz/images/parceiros/DREAMS_moz_elizabethglaser_logo.png" width="10%">
</font>
</div>
</div>
</div>
