...
class UtilizadoresSearch extends Utilizadores
{
    ...
    public function rules()
    {
        return [
            ...
            [['username', 'email', 'name', 'user_location2', 'password_hash', 'auth_key', 'password_reset_token', 'district_code', 'created_at', 'updated_at', 'confirmation_token', 'unconfirmed_email', 'recovery_token', 'registration_ip'], 'safe'],
        ];
    }
