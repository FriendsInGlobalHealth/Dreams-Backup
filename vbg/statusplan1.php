    			...
    			<div class="modal-content">
    				...
    				<div class="modal-body">
    					...
    					<div class="form-group">
							<input type="hidden" name="cause_plan_id" id="cause_plan_id" class="form-control" required />
    					</div>
											
    					<div class="form-group">
							<input type="hidden" name="cause_type_id" id="cause_type_id" class="form-control" required />
    					</div>  
						
    					<div class="form-group">
							<input type="hidden" name="intervention_plan_id" id="intervention_plan_id" class="form-control" required />
    					</div>						
						
    					<div class="form-group">
							<input type="hidden" name="responsible_plan_id" id="responsible_plan_id" class="form-control" required />
    					</div>						
						
    					<div class="form-group">	
							<input type="hidden" name="order_evaluaction_id" id="order_evaluaction_id" class="form-control" required />
						</div>	

    					<div class="form-group">
							<input type="hidden" name="action_plan_date" id="action_plan_date" class="form-control" required />
						</div>							
						
    					<div class="form-group">
							<input type="hidden" name="action_plan_period" id="action_plan_period" class="form-control" required />
						</div>						
