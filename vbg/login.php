                ...
                <div class="p-5">
				  ...
				  <?php echo $message; ?>
					...
					<label>User Email</label> <br>
                      <input type="email" class="form-control form-control-user" name="user_email" id="user_email" aria-describedby="emailHelp">
                    </div>
                    <div class="form-group">
					<label>Password</label> <br>
                      <input type="password" class="form-control form-control-user" name="user_password" id="user_password" >
                    </div>

					
            		<div class="form-group">
            			<input  class="btn btn-danger btn-user btn-block" type="submit" name="login" class="button" value="Login">
            		</div>					
                    <hr>
