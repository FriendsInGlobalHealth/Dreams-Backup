...
$query="INSERT INTO sa_evaluation_order 
(user_id, evaluation_order_date, evaluation_order_type, period_type, evaluation_equipe_clinic,evaluation_order_created_date,evaluation_order_status,evaluation_order_district,place_affection_id) 
	values 
('$user_id','$evaluation_order_date','$evaluation_order_type','$period_type','$evaluation_equipe_clinic','$evaluation_order_created_date','$evaluation_order_status','$evaluation_order_district','$place_affection_id')";

mysqli_close($connect);

if($insert=$mysqli->query($query)) { echo "Dados Inseridos com Sucesso"; 

$last_id=$mysqli->insert_id;

$_SESSION['evaluation_order_id'] = $last_id;
} else { echo "Dados nao Inseridos_".$mysqli->error;}
						...
						<div id="collapse<?php echo $rows_cursos['area_padrao_id']; ?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
							<div class="panel-body">
									...
									<tbody>
										...
										<input type="checkbox" name="item_quantity[]" value="0" class="btn btn-danger btn-xs" data-toggle="modal"  data-target="#brandModal" >Nao </input>
										</ul >
    				...
    				<div class="modal-body">
    					...
    					<div class="form-group">
    						<select name="cause_type_id" id="cause_type_id" class="form-control" required>
								<option value="">Selecione o tipo de Causa</option>
    					...
    					<div class="form-group">
    						<select name="intervention_plan_id" id="intervention_plan_id" class="form-control" required>
								<option value="">Selecione a Intervencao</option>
    					...
    					<div class="form-group">
							...
							<input type="hidden" name="order_evaluaction_id" value="<?= $last_id; ?>" id="order_evaluaction_id" class="form-control" />
