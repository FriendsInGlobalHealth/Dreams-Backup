...
if(isset($_POST['btn_action']))
{
	...
	{
		$query = "
		INSERT INTO sa_action_plan1 (cause_plan_id, cause_type_id, intervention_plan_id, user_id, responsible_plan_id, order_evaluaction_id, action_plan_date, action_plan_period) 
		VALUES (:cause_plan_id, :cause_type_id, :intervention_plan_id, :user_id, :responsible_plan_id, :order_evaluaction_id, :action_plan_date, :action_plan_period)
		";
	...
	if($_POST['btn_action'] == 'Edit')
	{
		...
		cause_plan_id = :cause_plan_id,
		cause_type_id = :cause_type_id,
		intervention_plan_id = :intervention_plan_id,
		user_id = :user_id,
		responsible_plan_id = :responsible_plan_id,		
		order_evaluaction_id = :order_evaluaction_id,
