...
<form class="form-horizontal" action="criar_avaliacao.php" method="post" enctype="multipart/form-data">
  ...
  <legend align="center" class="alert alert-dark" role="alert"><strong>REGISTO DE AVALIAÇÃO</strong></legend>
    ...
    <div class="form-inline" >
	  ...
	  <select class="form-control form-control-lg "  name="evaluation_order_type" >
...
<input type="hidden" name="evaluation_order_total" value="0.00"> 
  
  
 		<table class="table table-resposive table-sm table-hover table-borderless" style="width:100%"  >
			...
			<?php 
				if (mysqli_num_rows($result) > 0) {
					...
					<th scope="col">Distrito</th>
						<td>
						<input class="form-control form-control-lg" name="district_id" type="hidden" value="<?= $row["district_id"]; ?>" placeholder="<?php echo $row["district_name"]; ?>">
						<?php echo $row["district_name"]; ?>
						</td>
					</tr>
					
					<tr>
					<th scope="col">Nome da U.S.</th>
						<td>
						<input class="form-control form-control-lg" name="place_affection_id" type="hidden" value="<?= $row["place_affection_id"]; ?>" placeholder="<?php echo $row["place_affection_name"]; ?>">
					...
					<th>Periodo</th>
						<td>
							  ...
							  <select class="form-control form-control-lg"  name="period_id" >
					...
					<th>Nome do Avaliador</th>
						...
						<td>
						<input class="form-control form-control-lg" name="user_id" type="text" value="<?php $row["user_id"]; ?>" placeholder="<?php echo $row["user_name"]; ?>">
					...
					<th>Equipa de Medição </th>
						<td>
						<input class="form-control form-control-lg" type="text" name="evaluation_order_equipa_medica" placeholder="Equipa de Medição">
						</td>
					</tr>					
			...
			<legend align="center" class="alert alert-white" role="alert">		
				<button align="center" type="submit" name="submit" class="btn btn-danger">Gerar</button>
			</legend>	
