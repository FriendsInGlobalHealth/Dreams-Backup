			...
			<div class="panel panel-default">
                <div class="panel-heading">
                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
                        <div class="row">
                            <h3 class="panel-title">Periodo Plan</h3>
                        </div>
                    </div>
                ...
                <div class="panel-body">
                    <div class="row">
                    	<div class="col-sm-12 table-responsive">
                    		<table id="area_data" class="table table-bordered table-striped">
                    			<thead><tr>
									<th>ID</th>
									<th>period Name</th>
									<th>Status</th>
...
$(document).ready(function(){
	...
	$(document).on('click', '.update', function(){
		...
		$.ajax({
			url:"period_plan_action.php",
			method:"POST",
			data:{period_id:period_id, btn_action:btn_action},
			dataType:"json",
			success:function(data)
			{
	...
	var categorydataTable = $('#area_data').DataTable({
		"processing":true,
		"serverSide":true,
		"order":[],
		"ajax":{
			url:"period_plan_fetch.php",
			type:"POST"
		},
		"columnDefs":[
			{
	...
	$(document).on('click', '.delete', function(){
		...
		if(confirm("Are you sure you want to change status?"))
		{
			$.ajax({
				url:"period_plan_action.php",
				method:"POST",
				data:{period_id:period_id, status:status, btn_action:btn_action},
				success:function(data)
				{
