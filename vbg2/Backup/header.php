...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="http://dreams.co.mz/vbg/index.php">
		        <div class="sidebar-brand-icon rotate-n-15">
		<img src="http://dreams.co.mz/vbg/img/vbg_logo.png" height="70px">
		 </div>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="http://localhost/VBG_SAM/index.php">
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Avaliacoes:</h6>

			<a class="collapse-item" href="http://dreams.co.mz/vbg/parametrizacao/avaliacao/browse-users.php">Criar Avaliacao</a>
			<a class="collapse-item" href="http://dreams.co.mz/vbg/parametrizacao/avaliacao_activa_inactiva/index.php">Activar Avaliacoes</a>					
			<a class="collapse-item" href="http://dreams.co.mz/vbg/parametrizacao/Avaliacoes_Activas/index.php">Avaliacoes Activas</a>			
            ...
            <a class="collapse-item" href="http://dreams.co.mz/vbg/parametrizacao/avaliacao_Funcional/index.php">Avaliacao Padrao</a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Provedor</span>
