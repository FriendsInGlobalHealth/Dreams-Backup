...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($nome_categoria==""){
		...
		$insert	=	$db->insert('sa_categoria',$data);
		if($insert){
				...
				<div class="col-sm-6">
					...
					<form method="post">
						<div class="form-group">
							...
							<input type="text" name="nome_categoria" id="nome_categoria" class="form-control" placeholder="Enter name" required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary"><i class="fa fa-fw fa-plus-circle"></i> Add Categoria</button>
						</div>
					</form>
				</div>
			</div>
