...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($nome_previlegio==""){
		...
		$insert	=	$db->insert('sa_previlegio',$data);
		if($insert){
...
<body>
	...
	<div class="bg-light border-bottom shadow-sm sticky-top">
   	...
   	<div class="container">
		...
		?>
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Add privileges</strong> <a href="browse-users.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Browse Users</a></div>
			<div class="card-body">
				...
				<div class="col-sm-6">
					...
					<form method="post">
						<div class="form-group">
							...
							<input type="text" name="nome_previlegio" id="nome_previlegio" class="form-control" placeholder="Enter name" required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary"><i class="fa fa-fw fa-plus-circle"></i> Add privileges</button>
						</div>
					</form>
				</div>
			</div>
