...
<body>
	...
	<?php
	$condition	=	'';
	if(isset($_REQUEST['nome_previlegio']) and $_REQUEST['nome_previlegio']!=""){
		$condition	.=	' AND nome_previlegio LIKE "%'.$_REQUEST['nome_previlegio'].'%" ';
	}
	...
	$userData	=	$db->getAllRecords('sa_previlegio','*',$condition,'ORDER BY id');
	?>
						...
						<div class="row" >
							<div class="col-sm-2">
								<div class="form-group">
									<label>Name</label>
									<input type="text" name="nome_previlegio" id="nome_previlegio" class="form-control" value="<?php echo isset($_REQUEST['nome_previlegio'])?$_REQUEST['nome_previlegio']:''?>" placeholder=" name previleges">
								</div>
							</div>
							<div class="col-sm-2">
								<div class="form-group">
		...
		<div>
			<table class="table table-striped table-bordered">
				...
				<tbody>
					...
					<tr>
						<td><?php echo $s;?></td>
						<td><?php echo $val['nome_previlegio'];?></td>
