...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($nome_area_padrao==""){
		...
		$insert	=	$db->insert('sa_area_padrao',$data);
		if($insert){
				...
				<div class="col-sm-6">
					...
					<form method="post">
						<div class="form-group">
							...
							<input type="text" name="nome_area_padrao" id="nome_area_padrao" class="form-control" placeholder="Enter name" required>
						</div>
						<div class="form-group">
								...
								<label>Area:</label>
								<br>
								<select class="col-lg-10 col-lg-offset-2" name="area_id" id="area_id">
						...
						<div class="form-group">
							<button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary"><i class="fa fa-fw fa-plus-circle"></i> Add Area Padrao</button>
						</div>
					</form>
				</div>
			</div>
