...
<body>
	...
	<?php
	$condition	=	'';
	if(isset($_REQUEST['nome_provincia']) and $_REQUEST['nome_provincia']!=""){
		$condition	.=	' AND nome_provincia LIKE "%'.$_REQUEST['nome_provincia'].'%" ';
	}
	...
	$userData	=	$db->getAllRecords('sa_provincia','*',$condition,'ORDER BY id');
	?>
   

		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-globe"></i> <strong>Browse provincia</strong> <a href="add-users.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-plus-circle"></i> Add provincia</a></div>
			<div class="card-body">
				<?php
				...
				?>
				<div class="col-sm-12">
					<h5 class="card-title"><i class="fa fa-fw fa-search"></i> Find provincia</h5>
					<form method="get">
						<div class="row" >
							<div class="col-sm-2">
								<div class="form-group">
									<label>Nome provincia</label>
									<input type="text" name="nome_provincia" id="nome_provincia" class="form-control" value="<?php echo isset($_REQUEST['nome_provincia'])?$_REQUEST['nome_provincia']:''?>" placeholder=" name provincia">
								</div>
							</div>
							<div class="col-sm-2">
								<div class="form-group">
		...
		<div>
			<table class="table table-striped table-bordered">
				...
				<tbody>
					...
					<tr>
						<td><?php echo $s;?></td>
						<td><?php echo $val['nome_provincia'];?></td>
