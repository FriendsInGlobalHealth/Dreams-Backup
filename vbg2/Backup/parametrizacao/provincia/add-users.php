...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($nome_provincia==""){
		...
		$insert	=	$db->insert('sa_provincia',$data);
		if($insert){
				...
				<div class="col-sm-6">
					...
					<form method="post">
						<div class="form-group">
							...
							<input type="text" name="nome_provincia" id="nome_provincia" class="form-control" placeholder="Enter name" required>
						</div>
						<div class="form-group">
								...
								<label>Pais:</label>
								<br>
								<select class="col-lg-10 col-lg-offset-2" name="pais_id" id="pais_id">
						...
						<div class="form-group">
							<button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary"><i class="fa fa-fw fa-plus-circle"></i> Add provincia</button>
						</div>
					</form>
				</div>
			</div>
