...
<html lang="pt-br">
	...
	<body>
		...
		<form method="POST" action="salvar_post.php">
						...
						<br>
						<input class="col-lg-10 col-lg-offset-2" type="text" name="nome_bairro" placeholder="nome do bairro"> <br>									
						</div>

						<label>Latitude N</label>
						<br>
						<input class="col-lg-10 col-lg-offset-2" type="text" name="Latitude_N" placeholder="Latitude N"> <br>
						<br>

						<label>Longitude E</label>
						<br>
						<input class="col-lg-10 col-lg-offset-2" type="text" name="Longitude_E" placeholder="Longitude E"> <br>
						<br>			
