...
if(isset($_REQUEST['editId']) and $_REQUEST['editId']!=""){
	$row	=	$db->getAllRecords('sa_meio_verificacao','*',' AND id="'.$_REQUEST['editId'].'"');
}
...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	$update	=	$db->update('sa_meio_verificacao',$data,array('id'=>$editId));
	if($update){
...
<body>
	...
	<div class="bg-light border-bottom shadow-sm sticky-top">
   	...
   	<div class="container">
		...
		?>
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Add Meio de Verificacao</strong> <a href="browse-users.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Browse Meio de Verificacao</a></div>
			<div class="card-body">
				...
				<div class="col-lg-10 col-lg-offset-2">
					...
					<form method="post">
						<div class="form-group">
							<label>Name Meio de Verificacao <span class="text-danger">*</span></label>
							<input type="text" name="nome_meio_verificacao" id="nome_meio_verificacao" class="form-control" value="<?php echo $row[0]['nome_meio_verificacao']; ?>" placeholder="nome do Meio de Verificacao" required>
						</div>
						<div class="form-group">
							<label>Resposta <span class="text-danger">*</span></label>
							<input type="text" name="" id="resposta" class="form-control" value="<?php echo $row[0]['resposta']; ?>" placeholder="resposta" required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" name="area_padrao_id" id="area_padrao_id" class="form-control" value="<?php echo $row[0]['area_padrao_id']; ?>" placeholder="area_padrao_id" required>
						</div>
						<div class="form-group">
							<label>Criterio de Verificacao <span class="text-danger">*</span></label>
							<input type="text" name="criterio_verificacao_id" id="criterio_verificacao_id" class="form-control" value="<?php echo $row[0]['criterio_verificacao_id']; ?>" placeholder="distrito" required>
						</div>
					
						
						<div class="form-group">
							<input type="hidden" name="editId" id="editId" value="<?php echo $_REQUEST['editId']?>">
							<button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary"><i class="fa fa-fw fa-edit"></i> Update Meio de Verificacao</button>
						</div>
					</form>
				</div>
			</div>
