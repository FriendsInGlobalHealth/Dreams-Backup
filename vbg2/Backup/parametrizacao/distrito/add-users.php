...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	elseif($Estado==""){
		...
		$insert	=	$db->insert('sa_distrito',$data);
		if($insert){
				...
				<div class="col-sm-6">
					...
					<form method="post">
						<div class="form-group">
							...
							<input type="text" name="Nome_Distrito" id="Nome_Distrito" class="form-control" placeholder="Enter name" required>
						</div>
						...
						<div class="form-group">
							<button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary"><i class="fa fa-fw fa-plus-circle"></i> Add Distrito</button>
						</div>
					</form>
				</div>
			</div>
